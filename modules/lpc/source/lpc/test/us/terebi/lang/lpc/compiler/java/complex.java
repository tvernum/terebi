...
public class complex extends LpcObject
{
    ...
    public final LpcField _f_dwarf_kill = new LpcField( "dwarf_kill", withModifiers(us.terebi.lang.lpc.runtime.MemberDefinition.Modifier.PRIVATE) ,
    ...
    create_( )
    {
        ...
        final LpcValue _lpc_v16 = new LpcFunction(1) {
            public LpcValue execute(List<? extends LpcValue> args) {
                ...
                final LpcValue _lpc_v18 = efun("call_other").execute(getArg(args, 1) , _lpc_v17 , nil());
    ...
    target_killed_( @LpcParameter(kind=us.terebi.lang.lpc.runtime.LpcType.Kind.OBJECT, depth=0, name="target", semantics=us.terebi.lang.lpc.runtime.ArgumentSemantics.BY_VALUE) LpcValue _p_target_v )
    {
        ...
        final LpcValue _lpc_v26 = efun("call_other").execute(_p_target.get() , _lpc_v25 , nil());
