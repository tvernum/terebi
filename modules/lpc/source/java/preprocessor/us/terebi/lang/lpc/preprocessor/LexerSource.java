...
import static us.terebi.lang.lpc.preprocessor.Token.LAND_EQ;
import static us.terebi.lang.lpc.preprocessor.Token.LE;
import static us.terebi.lang.lpc.preprocessor.Token.LOR;
import static us.terebi.lang.lpc.preprocessor.Token.LOR_EQ;
...
public class LexerSource extends Source
{
    ...
    public LexerSource(Reader r, @SuppressWarnings("hiding") boolean ppvalid)
    {
    ...
    /* pp */final void error(String msg) throws LexerException
    {
        _error(msg, true);
    }

    /* Allow JoinReader to call this. */
    /* pp */final void warning(String msg) throws LexerException
    {
        _error(msg, false);
    }
    ...
    */
    ...
    private Token character() throws IOException, LexerException
    {
        ...
        return new Token(CHARACTER, text.toString(), Character.valueOf((char) d));
    }
    ...
    private Token string(char open, char close) throws IOException, LexerException
    {
        ...
        text.append(close);
        return new Token(close == '>' ? HEADER : STRING, text.toString(), buf.toString());
    }
    ...
    private Token number_octal() throws IOException, LexerException
    {
        ...
        return new Token(INTEGER, text.toString(), Long.valueOf(val));
    }
    ...
    private Token heredoc(boolean arrayFormat) throws IOException, LexerException
    {
        ...
        for (;;)
        {
            ...
            if (buffer.length() == tag.length() && buffer.toString().equals(tag.toString()))
            {
                c = peek();
                if (!isTextMarkerChar(c))
                {
