 ...
 * 
 */
public class RepeatStringEfun extends AbstractEfun implements FunctionSignature, Callable
{
    ...
    protected List< ? extends ArgumentDefinition> defineArguments()
    {
        ...
        list.add(new ArgumentSpec("count", Types.INT));
        return list;
    }
    ...
    public LpcValue execute(List< ? extends LpcValue> arguments)
    {
        ...
        long count = arguments.get(1).asLong();
