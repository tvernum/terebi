...
public class MethodTestObject extends LpcObject
{
    ...
    LpcValue o)
    {
        LpcValue _lpc_v1 = makeValue("getName");
        LpcValue _lpc_v2 = efun("call_other").execute(o, _lpc_v1);
        LpcValue _lpc_v3 = efun("implode").execute(s, _lpc_v2);
        return _lpc_v3;
    }
}
