 ...
 * @version $Revision$
 */
public class RestoreVariableEfun extends AbstractEfun
{
    protected List< ? extends ArgumentDefinition> defineArguments()
    {
        return Collections.singletonList(new ArgumentSpec("value", Types.STRING));
    }
    ...
    public LpcValue execute(List< ? extends LpcValue> arguments)
    {
        ...
        return ObjectSerializer.restore(thisObject, value);
    }
}
